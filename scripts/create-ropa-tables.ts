...
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/complianceos';
...
async function createTables() {
    ...
    try {
        console.log('Creating processing_activities table...');
    ...
    `);
        ...
        console.log('Creating processing_activity_vendors table...');
        await db.execute(sql`
    ...
    `);
        ...
        console.log('Creating processing_activity_assets table...');
        await db.execute(sql`
    ...
    `);
        ...
        console.log('✅ All ROPA tables created successfully!');
        await client.end();
        process.exit(0);
    } catch (error) {
