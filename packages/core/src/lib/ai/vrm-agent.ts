...
export interface TrustCenterAnalysis {
    score: number;
    // True when this analysis was generated by the built-in deterministic
    // demo generator instead of a real AI provider / live trust-center scan.
    // Downstream UI must surface this so simulated data is never mistaken
    // for verified vendor evidence.
    simulated?: boolean;
    docs: Array<{
        name: string;
        url: string;
