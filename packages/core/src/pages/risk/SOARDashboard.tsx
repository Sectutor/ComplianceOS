                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-slate-900">SOAR Dashboard</h1>
                                <p className="text-slate-500">Security Orchestration & Automation</p>
                            </div>
                        </div>
                    ...
                    <Tabs defaultValue="cases" className="space-y-4">
                        <TabsList className="bg-white border-slate-200">
                            ...
                            <TabsTrigger value="playbooks" className="data-[state=active]:bg-purple-600">Playbooks</TabsTrigger>
                            <TabsTrigger value="metrics" className="data-[state=active]:bg-purple-600">Metrics</TabsTrigger>
                        </TabsList>
