        ...
        <DashboardLayout>
            <div className="space-y-8">
                ...
                <div className="grid gap-4 grid-cols-1 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    <div className="p-4 rounded-xl border border-indigo-200 bg-white shadow-sm flex flex-col justify-between cursor-pointer hover:border-indigo-400 hover:shadow-md transition-all group" onClick={() => window.location.href = `/clients/${clientId}/governance/overview`}>
