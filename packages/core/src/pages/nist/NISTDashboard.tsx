...
export default function NISTDashboard() {
    ...
    // Mock scores for now - in real implementation this would come from TRPC
                    ...
                    <div className="hidden md:flex justify-center relative">
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-3xl w-full max-w-sm">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Badge variant="outline" className="border-blue-400 text-blue-300">Tier 2</Badge>
                            </div>
                            <div className="flex items-end gap-2 mb-2">
                                <span className="text-5xl font-extrabold text-blue-400">{overallScore}%</span>
                                <span className="text-slate-400 mb-2">implemented</span>
                            </div>
                            <Progress value={overallScore} className="h-3 bg-white/10 mb-6" />

                            <div className="grid grid-cols-2 gap-3">
                                <div className="p-3 bg-white/5 rounded-xl border border-white/5">
                                    <div className="text-xs text-slate-400 uppercase font-bold mb-1">Target</div>
                                    <div className="text-white font-bold flex items-center gap-2">
                                        <Target className="h-4 w-4 text-emerald-400" /> Tier 3
                                    </div>
                                </div>
                                <div className="p-3 bg-white/5 rounded-xl border border-white/5">
                                    <div className="text-xs text-slate-400 uppercase font-bold mb-1">Profile</div>
