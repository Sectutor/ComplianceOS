                                ...
                                <div className="text-center py-6">
                                    <div className="inline-flex items-center justify-center relative w-32 h-32">
                                        <svg className="w-32 h-32 transform -rotate-90">
                                            ...
                                            <circle cx="64" cy="64" r="58" stroke="currentColor" strokeWidth="12" fill="transparent" strokeDasharray={364.4} strokeDashoffset={364.4 * (1 - 0.68)} className="text-indigo-600 transition-all duration-1000" />
                                        </svg>
                                        <span className="absolute text-3xl font-black text-slate-900">68%</span>
                                    </div>
                                    <p className="text-xs font-bold text-slate-400 mt-4 uppercase tracking-widest">221 of 325 Controls</p>
                                </div>
                        ...
                        <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-slate-900 text-white">
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                                    ...
                                    <div>
                                        <p className="text-sm font-bold">AWS Environment</p>
                                        <p className="text-[10px] text-slate-500 uppercase font-black">Connected / us-east-1</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/10 opacity-50">
                                    <Terminal className="w-5 h-5 text-emerald-400" />
                                    <div>
                                        <p className="text-sm font-bold">Terraform Cloud</p>
                                        <p className="text-[10px] text-slate-500 uppercase font-black">Sync Pending...</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Tabs defaultValue="implementation" className="w-full">
                            <div className="border-b px-8 bg-slate-50/50">
                                <TabsList className="h-16 bg-transparent gap-8">
                                    <TabsTrigger value="implementation" className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-indigo-600 data-[state=active]:shadow-none rounded-none font-black text-xs uppercase tracking-widest">
                                        Control Execution
                                    </TabsTrigger>
                                    <TabsTrigger value="ssp" className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-indigo-600 data-[state=active]:shadow-none rounded-none font-black text-xs uppercase tracking-widest">
                                        SSP Documentation
                                    </TabsTrigger>
                                    <TabsTrigger value="evidence" className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-indigo-600 data-[state=active]:shadow-none rounded-none font-black text-xs uppercase tracking-widest">
                                        Technical Evidence
                                    </TabsTrigger>
                                </TabsList>
                            </div>
                            ...
                            <ScrollArea className="h-[650px]">
                                <TabsContent value="implementation" className="p-10 space-y-8 m-0">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex gap-2">
                                            <Button variant="outline" className="rounded-xl h-10 font-bold text-xs uppercase tracking-widest gap-2">
                                                ...
                                                <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
                                                    ...
                                                    <div className="flex-1 space-y-4">
                                                        ...
                                                        <div className="flex gap-3 pt-2">
                                                            <Button className="bg-slate-900 hover:bg-slate-800 text-white rounded-xl h-10 px-6 font-bold text-xs uppercase tracking-widest gap-2">
                                                                Update Status
                                                            </Button>
                                                            <Button variant="outline" className="rounded-xl h-10 px-6 font-bold text-xs uppercase tracking-widest gap-2">
                                                                Review Requirement
                                                            </Button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="p-10 bg-indigo-900 rounded-[3.5rem] text-white relative overflow-hidden flex flex-col md:flex-row items-center gap-10">
                                        ...
                                        <div className="relative z-10 space-y-4 text-center md:text-left">
                                            ...
                                            <div className="flex gap-4 pt-2">
                                                ...
                                                <Button variant="outline" className="border-indigo-700 text-white hover:bg-indigo-800 rounded-2xl h-12 px-8 font-black uppercase tracking-widest text-xs">
                                                    Download PDF Draft
                                                </Button>
                                            </div>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="bg-slate-50 p-8 rounded-[3rem] border border-slate-100 space-y-6">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <Button className="w-full bg-indigo-50 hover:bg-indigo-100 text-indigo-600 border border-indigo-200 rounded-xl h-12 font-bold gap-2">
                                ...
                                <TabsContent value="evidence" className="p-10 space-y-8 m-0">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        {[
                                            { title: "Configuration Snapshots", count: 12, icon: Camera },
                                            { title: "Test Results", count: 4, icon: ListChecks },
                                            { title: "Policy Artifacts", count: 8, icon: FileText }
                                        ].map((box, i) => (
                                            <div key={i} className="p-8 bg-white border rounded-[2.5rem] flex flex-col items-center text-center space-y-4 hover:shadow-lg transition-all cursor-pointer group">
                                    ...
                                    <div className="p-10 border-2 border-dashed border-slate-200 rounded-[3.5rem] bg-slate-50/50 text-center space-y-6">
                                        ...
                                        <Button className="bg-slate-900 hover:bg-slate-800 text-white rounded-2xl h-14 px-10 font-black text-lg gap-3">
