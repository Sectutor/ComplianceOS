                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm mt-1 font-medium">
                            Comprehensive reporting engine for <span className="text-indigo-600 font-bold">{client.name}</span>. Produce consulting-grade DOCX and PDF documents across all compliance domains.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        <Button
                            ...
                            className={cn("font-bold text-xs rounded-xl", activeTab === 'dashboard' ? "bg-slate-900 text-white" : "border-slate-300")}
                        >
                        ...
                        <Button
                            ...
                            className={cn("font-bold text-xs rounded-xl", activeTab === 'studio' ? "bg-indigo-600 text-white shadow-md shadow-indigo-200" : "border-slate-300")}
                        >
                        ...
                        <Button
                            ...
                            className={cn("font-bold text-xs rounded-xl", activeTab === 'history' ? "bg-slate-900 text-white" : "border-slate-300")}
                        >
                ...
                {activeTab === 'studio' && (
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center justify-between gap-1">
                                                        ...
                                                        <Badge variant="outline" className="text-[9px] px-1.5 py-0 border-none font-bold bg-white text-slate-600 shrink-0">
                                                            {preset.badge}
                                                        </Badge>
                                                    </div>
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={cn(
                                                    ...
                                                    isChecked ? "bg-indigo-500 border-indigo-400 text-white" : "border-slate-300 bg-white"
                                                )}>
                                                    {isChecked && <Check className="w-3 h-3 stroke-[3]" />}
                                                </div>
                                                <div>
                                                    <div className="font-bold">{sec.name}</div>
                                                    <div className={cn("text-[10px]", isChecked ? "text-slate-300" : "text-slate-500")}>
                                                        {sec.desc}
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <Card className="border-slate-200 shadow-md rounded-2xl bg-white p-6 space-y-5">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full text-base font-bold text-slate-900 px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                ...
                                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    <div>
                                        <div className="text-xs font-bold text-slate-700">Target Audience Profile</div>
                                        <div className="text-sm font-bold text-indigo-600">{selectedPreset.targetAudience}</div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Button
                                            onClick={() => handleExport('docx')}
                                            disabled={isGeneratingDocx || isGeneratingPdf}
                                            className="bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl h-10 px-4 text-xs transition-all shadow-md flex items-center"
                                        >
                                            {isGeneratingDocx ? (
                                        ...
                                        <Button
                                            ...
                                            disabled={isGeneratingDocx || isGeneratingPdf}
                                            className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl h-10 px-4 text-xs transition-all shadow-md shadow-indigo-200 flex items-center"
                                        >
                                            {isGeneratingPdf ? (
                                                <Loader2 className="w-3.5 h-3.5 animate-spin mr-1.5" />
                                            ) : (
                            ...
                            <Card className="border-slate-200 shadow-xl rounded-2xl bg-white overflow-hidden">
                                <CardHeader className="bg-slate-900 text-white p-6 border-b border-slate-800">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Badge className="bg-white/10 text-slate-300 border-none text-[10px] font-mono">
                                            CONFIDENTIAL
                                        </Badge>
                                    </div>
                                ...
                                <CardContent className="p-6 space-y-6 text-slate-800 bg-slate-50/30">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                        <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-xs">
                                            ...
                                            <div className="text-xl font-black text-indigo-600">{metrics.readinessPercent}%</div>
                                            <div className="text-[10px] text-emerald-600 font-bold">+5% vs last period</div>
                                        </div>
                                        <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-xs">
                                            <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Residual Risk</div>
                                            <div className="text-xl font-black text-amber-600">{metrics.riskScore}</div>
                                            <div className="text-[10px] text-slate-500 font-medium">Risk Appetite: Met</div>
                                        </div>
                                        <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-xs">
                                            <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Critical Gaps</div>
                                        ...
                                        <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-xs">
                                            ...
                                            <div className="text-[10px] text-slate-500 font-medium">Cadence: High</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3 pt-2">
                                        ...
                                        <div className="divide-y divide-slate-200 bg-white rounded-xl border border-slate-200 overflow-hidden text-xs">
                                                ...
                                                return (
                                                    <div key={secId} className="p-3 flex items-center justify-between">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="font-bold text-slate-800">{sec?.name || secId}</span>
                                                        </div>
                                        ...
                                        <div key={report.id} className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-slate-50 transition-colors">
                                            <div className="space-y-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Badge variant="outline" className="text-[10px] font-bold bg-slate-100 text-slate-700 border-none">
                                                        {report.version || 'v1.0'}
                                                    </Badge>
                                                </div>
