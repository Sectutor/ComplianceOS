...
Use this skill when you are working as the compliance agent for a GRCompliance instance. It teaches you the API surface, common CISO workflows, and automation patterns.
